...
import desugarers/split_with_group_by_group_replacement_instructions
...
pub const split_with_group_by_group_replacement_instructions = split_with_group_by_group_replacement_instructions.split_with_group_by_group_replacement_instructions
...
pub const assertive_tests : List(fn() -> infra.AssertiveTests) = [
  ...
  split_with_group_by_group_replacement_instructions.assertive_tests,
