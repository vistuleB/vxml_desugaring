...
const name = "associate_counter_by_prepending_incrementing_attribute_depr"
const constructor = associate_counter_by_prepending_incrementing_attribute_depr
...
pub fn associate_counter_by_prepending_incrementing_attribute_depr(
  param: Param,
) -> Desugarer {
  Desugarer(
    name,
