...
const name = "replace_regex_matches_with_outside"
const constructor = replace_regex_matches_with_outside
...
pub fn replace_regex_matches_with_outside(param: Param) -> Desugarer {
  Desugarer(
    name,
