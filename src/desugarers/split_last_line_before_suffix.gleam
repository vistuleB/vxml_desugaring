        ...
        False -> {
          ...
          case trimmed_start == "" {
            True -> T(
              blame,
              [
                BlamedContent(suffix_blame, suffix), ..rest
              ] |> list.reverse
            )
            False -> {
              T(
                blame,
                [
                  BlamedContent(suffix_blame, suffix),
                  BlamedContent(first.blame, trimmed_start),
                  ..rest,
                ] |> list.reverse
              )
            }
...
/// specified tag
pub fn split_last_line_before_suffix(param: Param) -> Desugarer {
  Desugarer(
    name,
