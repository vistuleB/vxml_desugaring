...
const name = "unwrap_if_no_child_meets_condition_depr"
const constructor = unwrap_if_no_child_meets_condition_depr
...
pub fn unwrap_if_no_child_meets_condition_depr(param: Param) -> Desugarer {
  Desugarer(
    name,
