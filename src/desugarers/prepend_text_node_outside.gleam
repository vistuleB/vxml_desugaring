...
fn param_to_inner_param(param: Param) -> Result(InnerParam, DesugaringError) {
  let blame = infra.blame_us("prepend_text_node_outside")
  #(
    param.0,
    T(
      blame,
...
const name = "prepend_text_node_outside"
const constructor = prepend_text_node_outside
...
pub fn prepend_text_node_outside(param: Param) -> Desugarer {
  Desugarer(
    name,
