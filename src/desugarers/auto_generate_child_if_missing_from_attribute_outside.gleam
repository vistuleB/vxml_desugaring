...
const name = "auto_generate_child_if_missing_from_attribute_outside"
const constructor = auto_generate_child_if_missing_from_attribute_outside
...
pub fn auto_generate_child_if_missing_from_attribute_outside(param: Param) -> Desugarer {
  Desugarer(
    name,
