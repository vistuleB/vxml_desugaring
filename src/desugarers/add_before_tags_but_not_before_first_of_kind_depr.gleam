...
const name = "add_before_tags_but_not_before_first_of_kind_depr"
const constructor = add_before_tags_but_not_before_first_of_kind_depr
...
pub fn add_before_tags_but_not_before_first_of_kind_depr(param: Param) -> Desugarer {
  Desugarer(
    name,
