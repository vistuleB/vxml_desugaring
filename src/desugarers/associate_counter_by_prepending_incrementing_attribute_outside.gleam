...
const name = "associate_counter_by_prepending_incrementing_attribute_outside"
const constructor = associate_counter_by_prepending_incrementing_attribute_outside
...
pub fn associate_counter_by_prepending_incrementing_attribute_outside(
  param: Param,
) -> Desugarer {
  Desugarer(
    name,
