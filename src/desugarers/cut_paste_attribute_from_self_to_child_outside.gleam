...
const name = "cut_paste_attribute_from_self_to_child_outside"
const constructor = cut_paste_attribute_from_self_to_child_outside
...
/// 'parent_tag'.
pub fn cut_paste_attribute_from_self_to_child_outside(param: Param) -> Desugarer {
  Desugarer(
    name,
