...
const name = "prepend_text_node_if_has_ancestor_else_plural"
const constructor = prepend_text_node_if_has_ancestor_else_plural
...
pub fn prepend_text_node_if_has_ancestor_else_plural(param: Param) -> Desugarer {
  Desugarer(
    name,
